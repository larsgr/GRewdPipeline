...
myTree <- read.tree(text = "(((((Bd_R:1,BrDi:1):1,(Hv_R:1,HoVu:1):1):1,(MeNu1:1,MeNu2:1):2):1,NaSt:4):1,StLa:5):0;")

treePath <- "/mnt/NOBACKUP/mariansc/share/orthos/trees"
...
for(i in 1:20){
  plotSplit(as.integer(names(splitCounts[i])),label, 
            main=paste("Occurences: ",splitCounts[i]))
}
