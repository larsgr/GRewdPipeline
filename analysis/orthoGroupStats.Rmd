...
source("~/networkSimilarity/R/loadOrthoGroups.R")
```
...
nSpcPerGrpTbl <- sapply(setNames(1:8,1:8),function(x){apply((lens>0)[nSpcPerGrp==x, ],2,sum)/x})
cols <- brewer.pal(n = 8,name = "Set2")
barplot(nSpcPerGrpTbl,col=cols,legend.text = colnames(lens),horiz = T,
        ylab='Number of "species" represented',xlab="Ortho group")
```
