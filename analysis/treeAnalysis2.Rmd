---
title: "treeAnalysis2 DNA based trees"
...
treePepPath <- "/mnt/NOBACKUP/mariansc/share/orthos/trees"
treePepFiles <- dir(treePepPath,pattern="\\.tree$")

lapply(setNames(file.path(treePepPath,treePepFiles),
                stringr::str_extract(treePepFiles,"grp[0-9]+")), read.tree
       ) -> allPepTrees
...
all11PepTrees <- allPepTrees[names(allPepTrees) %in% grpIDs11]
