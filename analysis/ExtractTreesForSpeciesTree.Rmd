...
It was found that filtering on core/basal split existance could bias the estimated species tree. Therefore we added the this groups that also holds the condition in alternative 1 above (`r sum(singletonWithOsNoCoreClan)`)
...
# inFastaPath <- "~/GRewd/codonAlignments/singletonWithOs"
# outBeastPath <- "~/GRewd/codonAlignments/beast_singletonWithOs"
inFastaPath <- "~/GRewd/codonAlignments/singletonWithOsNoCoreClan"
outBeastPath <- "~/GRewd/codonAlignments/beast_singletonWithOsNoCoreClan"
...
beastWorkDir <- "~/GRewd/codonAlignments/beastOut_singletonWithOsNoCoreClan"
...
```{r simenScripts, OLD funker ikke }
library(plyr)
library(ape)
